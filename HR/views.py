...
def home(request):
    ...
    ,'BRAND_NAME' :  globalSettings.BRAND_NAME,'ORDERS_STATUS_LIST' :  globalSettings.ORDERS_STATUS_LIST, 'serviceName' : globalSettings.SERVICE_NAME , 'defaultRoute' : defaultRoute , 'showCommonApps' : showCommonApps,'storeName':storeName,'storePk':storePk})
