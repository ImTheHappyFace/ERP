...
class userProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = profile
        fields = ( 'pk' , 'mobile' , 'displayPicture'  )

class userProfileAdminModeSerializer(serializers.ModelSerializer):
    """ Only admin """
    class Meta:
        model = profile
        fields = ( 'pk','user','displayPicture' , 'mobile')
...
class userSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('pk' , 'username' , 'email' , 'first_name' , 'last_name'  ,'profile'  ,'settings' , 'password' , 'is_active','is_staff')
